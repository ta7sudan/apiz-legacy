...
export declare type APIzInstance<RawRequestOptions = any, T extends Record<string, APIInfo<any, any>> = Record<string, APIInfo<any, any>>, Method extends HTTPMethodLowerCase = HTTPMethodLowerCase> = Omit<ProxyGroup<RawRequestOptions, T>, 'add'> & {
...
export declare function APIz<RawRequestOptions = any, ContentType = any, Meta = any, Method extends HTTPMethodLowerCase = HTTPMethodLowerCase, T extends Record<string, APIInfo<ContentType, Meta>> = Record<string, APIInfo<ContentType, Meta>>>(this: APIzInstance<RawRequestOptions, T, Method>, group: APIGroup<T>, options?: APIzOptions<RawRequestOptions, ContentType, Meta, Method>): APIzInstance<RawRequestOptions, T, Method>;
export declare function config<RawRequestOptions, ContentType = any, Meta = any, Method extends HTTPMethodLowerCase = HTTPMethodLowerCase>({ querystring, paramRegex, client, reset, defaultType: dt }?: GlobalAPIzOptions<RawRequestOptions, ContentType, Meta, Method>): void;
export {};
